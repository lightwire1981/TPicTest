...
public class ListAdptRankingGoods extends RecyclerView.Adapter<ListAdptRankingGoods.ViewHolder>{
    private Context context;
    private final ArrayList<ListItemRankingGoods> mData;

    private final String TAG = getClass().getName();

    public ListAdptRankingGoods(ArrayList<ListItemRankingGoods> list) {
        mData = list;
    }
    ...
    @NotNull
    @Override
    public ListAdptRankingGoods.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ListItemRankingGoods item = mData.get(position);

        holder.goodsRank.setText(String.valueOf(position+1));
        Glide.with(context).
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ImageView goodsImg;
        TextView goodsRank, goodsCategory, goodsName, goodsPrice, goodsRate, goodsReviews;

        public ViewHolder(View itemView) {
            super(itemView);
            goodsImg = itemView.findViewById(R.id.iVwRankListProductImg);
            goodsRank = itemView.findViewById(R.id.tVwRankingNumber);
            goodsCategory = itemView.findViewById(R.id.tVwRankListCategoryType);
            goodsName = itemView.findViewById(R.id.tVwRankListProductName);
            goodsPrice = itemView.findViewById(R.id.tVwRankListProductPrice);
            goodsRate = itemView.findViewById(R.id.tVwRankListEval);
            goodsReviews = itemView.findViewById(R.id.tVwRankListReviewCount);
        }
    }
}
